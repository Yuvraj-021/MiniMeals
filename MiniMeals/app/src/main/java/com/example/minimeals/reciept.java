...
import com.example.minimeals.model.Requests;
       ...
       // customername=user.getDisplayName();
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(reciept.this,databaseError.getMessage(),Toast.LENGTH_LONG).show();
            }
        });
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               b=foodname.getText().toString().trim();
                ...
                if(selectedId==-1){
                    Toast.makeText(reciept.this,"Nothing selected", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(reciept.this,radiobutton.getText(), Toast.LENGTH_SHORT).show();
                }

                if(radiobutton.getText().equals("PAY USING UPI"))
                {
                    Intent i1=new Intent(reciept.this,paymentpg.class);
